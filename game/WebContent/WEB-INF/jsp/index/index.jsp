  ...
  <div class="layui-header header header-demo">
    <div class="layui-main">
      ...
      <ul class="layui-nav" lay-filter="" >
        ...
        <li class="layui-nav-item" id="tou"><img src="${root}static${userinfo.touxiang}" class="layui-circle" style="border: 2px solid #A9B7B7;" width="35px" height="35px" alt=""></li>
  ...
  <div class="layui-side layui-bg-black x-side show_list" style="left:0px;" id="table1">
    ...
    <div class="layui-side-scroll">
      <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
        ...
        <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;"> <i class="layui-icon iconfont" style="top: 3px;">&#xe64c;</i><cite>竞赛管理</cite> </a>
          <dl class="layui-nav-child">
            <dd class="">
            <dd class=""> <a href="javascript:;" _href="${root}ht/selkebaoming.action"> <cite>竞赛信息列表</cite> </a> </dd>
            </dd>
             <dd class="">
            <dd class=""> <a href="javascript:;" _href="${root}ht/selBuildinfo.action"> <cite>个人建赛列表</cite> </a> </dd>
            </dd>
          </dl>
        </li>
        <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;"> <i class="layui-icon iconfont" style="top: 3px;">&#xe67d;</i><cite>竞赛设置</cite> </a>
          <dl class="layui-nav-child">
          	<dd class="">
            <dd class=""> <a href="javascript:;" _href="${root}ht/selkefabu.action"> <cite>竞赛待发布列表</cite> </a> </dd>
            </dd>
            <dd class="">
            <dd class=""> <a href="javascript:;" _href="${root}ht/seldaikaishi.action"> <cite>竞赛待开始列表</cite> </a> </dd>
            </dd>
            <dd class="">
            <dd class=""> <a href="javascript:;" _href="${root}ht/selyiwancheng.action"> <cite>竞赛已完成列表</cite> </a> </dd>
            </dd>
            <dd class="">
            <dd class=""> <a href="javascript:;" _href=""> <cite>参赛者信息列表</cite> </a> </dd>
            </dd>
			<dd class="">
            <dd class=""> <a href="javascript:;" _href=""> <cite>随机分组</cite> </a> </dd>
            </dd>
          </dl>
        </li>
        <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;"> <i class="layui-icon " style="top: 3px;">&#xe634;</i><cite>竞赛管理</cite> </a>
          <dl class="layui-nav-child">
            <dd class="">
            <dd class=""> <a href="javascript:;" _href=""> <cite>建赛管理</cite> </a> </dd>
            </dd>
            <dd class="">
            <dd class=""> <a href="javascript:;" _href=""> <cite>竞赛设置</cite> </a> </dd>
            </dd>
            <dd class="">
            <dd class=""> <a href="javascript:;" _href=""> <cite>竞赛信息</cite> </a> </dd>
            </dd>
          </dl>
        </li>

        <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;"> <i class="layui-icon iconfont" style="top: 3px;">&#xe621;</i><cite>教师管理</cite> </a>
          <dl class="layui-nav-child">
            <dd class=""> <a href="javascript:;" _href=""> <cite>修改密码</cite> </a> </dd>
          </dl>
