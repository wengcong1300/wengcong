  ...
  <div class="layui-header header header-demo">
    <div class="layui-main">
      ...
      <ul class="layui-nav" lay-filter="" >
        ...
        <li class="layui-nav-item" id="tou"><img src="${root}/static/images/bg.png" class="layui-circle" style="border: 2px solid #A9B7B7;" width="35px" height="35px" alt=""></li>
  ...
  <div class="layui-side layui-bg-black x-side show_list" style="left:0px;" id="table1">
    ...
    <div class="layui-side-scroll">
      <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
        <li class="layui-nav-item"> <a class="javascript:;" > <i class="layui-icon iconfont" style="top: 3px;">&#xe66b;</i><cite>用户状态管理</cite> </a>
          <dl class="layui-nav-child">
            <dd class="">
            <dd class=""> <a href="javascript:;" _href="${root}gly/selectusersetting.action"> <cite>用户信息</cite> </a> </dd>
            </dd>
            <dd class="">
            <dd class=""> <a href="javascript:;" _href="${root}gly/selkebaomingall.action"> <cite>比赛信息</cite> </a> </dd>
            </dd>
          </dl>
        </li>
         
        <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;">  <i class="layui-icon iconfont" style="top: 3px;">&#xe683;</i><cite>密码管理</cite> </a>
          <dl class="layui-nav-child">
