    ...
    <div class="layui-side-scroll">
      <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
        <li class="layui-nav-item"> <a class="javascript:;" > <i class="layui-icon iconfont" style="top: 3px;">&#xe66b;</i><cite>用户信息</cite> </a>
          <dl class="layui-nav-child">
            <dd class="">
            <dd class=""> <a href="javascript:;" _href="${root}ptyh/yhxx/selxinxi.action"> <cite>个人信息</cite> </a> </dd>
            </dd>
            <dd class="">
        ...
        <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;"> <i class="layui-icon iconfont" style="top: 3px;">&#xe64c;</i><cite>竞赛信息管理</cite> </a>
          <dl class="layui-nav-child">
            <dd class="">
            <dd class=""> <a href="javascript:;" _href="${root}ptyh/jsxx/selkebaoming.action"> <cite>可报名竞赛</cite> </a> </dd>
            </dd>
            <dd class="">
            <dd class=""> <a href="javascript:;" _href="${root}ptyh/jsxx/seldaikaishiall.action"> <cite>即将开始竞赛</cite> </a> </dd>
            </dd>
             <dd class="">
            <dd class=""> <a href="javascript:;" _href="${root}ptyh/jsxx/selectgameover.action"> <cite>已结束竞赛</cite> </a> </dd>
            </dd>
          </dl>
        </li>
        <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;"> <i class="layui-icon iconfont" style="top: 3px;">&#xe67d;</i><cite>个人竞赛管理</cite> </a>
          <dl class="layui-nav-child">
          	<dd class="">
            <dd class=""> <a href="javascript:;" _href="${root}ptyh/grjs/xianshibaoming.action"> <cite>个人报名记录</cite> </a> </dd>
            </dd>
            <dd class="">
            <dd class=""> <a href="javascript:;" _href="${root}ptyh/grjs/gerencansai.action"> <cite>个人参赛记录</cite> </a> </dd>
            </dd>
            <dd class="">
            <dd class=""> <a href="javascript:;" _href="${root}ptyh/grjs/selectgerenhuojiang.action"> <cite>个人获奖记录</cite> </a> </dd>
            </dd>
          </dl>
        </li>
      </ul>
			...
			$.ajax({
				   ...
				   success: function(msg){
					   if(msg.code==1){
						   ...
						   alert(msg.message);
						   x_admin_show('用户信息','${root}ptyh/yhxx/toxinxi.action','400','450');
						   }
				   }
				}); 	
				return false;
...
<script>
		function geren(){
			$.ajax({
		 		   ...
		 		   success: function(msg){
		 			   if(msg.code==1){
		 				  x_admin_show('用户信息','${root}ptyh/yhxx/selxinxi.action','400','450');
		 				   }
		 			   else{
		 				   alert(msg.message);
		 				   x_admin_show('用户信息','${root}ptyh/yhxx/toxinxi.action','400','450');
