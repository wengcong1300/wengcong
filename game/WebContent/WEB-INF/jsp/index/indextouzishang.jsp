      ...
      <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
        ...
        <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;"> <i class="layui-icon iconfont" style="top: 3px;">&#xe67d;</i><cite>竞赛设置</cite> </a>
          <dl class="layui-nav-child">
            ...
            <dd class="">
            <dd class=""> <a href="javascript:;" _href="${root}ht/selyifabu.action"> <cite>竞赛已发布列表</cite> </a> </dd>
            </dd>
            <dd class="">
            <dd class=""> <a href="javascript:;" _href="${root}ht/seldaikaishi.action"> <cite>竞赛待开始列表</cite> </a> </dd>
            </dd>
            <dd class="">
            <dd class=""> <a href="javascript:;" _href="${root}ht/seljinxingzhong.action"> <cite>竞赛进行中列表</cite> </a> </dd>
            </dd>
            <dd class="">
