...
<form class="layui-form" action="" lay-filter="example">
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" id="gamename" name="gamename" required="required" value="${buildinfo.gamename }" lay-verify="title" autocomplete="off" placeholder="请输入比赛名称" class="layui-input">
    </div>
  </div>
  ...
  <div class="layui-form-item layui-form-text">
    ...
    <div class="layui-input-block">
      <textarea placeholder="请输入比赛描述" id="miaoshu"   class="layui-textarea" name="miaoshu">${buildinfo.miaoshu }</textarea>
    </div>
  </div>
  <div class="layui-form-item layui-form-text">
    <label class="layui-form-label">比赛规则</label>
    <div class="layui-input-block">
      <textarea placeholder="请输入比赛规则" id="guize" class="layui-textarea" name="guize">${buildinfo.guize }</textarea>
    </div>
  </div>
...
<script type="text/javascript">
	$(".layui-form").submit(function(){
		...
		var guize=$("#guize").val();
		var params="buildid="+buildid+"&"+"gamename="+gamename+"&"+"miaoshu="+miaoshu+"&"+"guize="+guize; 
		console.log(params);
		$.ajax({
			   type: "POST",
			   url: "${root}tzs/sjjs/updateBuildinfo.action",
			   data: params,
