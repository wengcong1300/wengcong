...
<html>
    ...
    <body>
        ...
        <div class="x-body">
            ...
            <button class="layui-btn" onclick="role_add('建立赛事窗口','${root}ht/toinsertBuildinfo.action','900','500')">
            <i class="layui-icon">&#xe608;</i>
            添加
            </button>
            ...
            <table class="layui-table">
                ...
                <tbody>     
					...
					<tr>
						...
						<td>${user.email}</td>
                        <td class="td-manage">
                            <a title="编辑" href="javascript:;" onclick="role_edit('编辑','${root}ht/toupdateBuildinfo.action?buildid=${buildinfo.buildid}','4','','510')"
                            class="ml-5" style="text-decoration:none">
                                <i class="layui-icon">&#xe642;</i>
                            </a>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                           <a title="删除" href="${root}ht/deletebuildinfo.action?buildid=${buildinfo.buildid}" onclick="return confirm('是否真的删除？')"
             ...
             function delAll () {
                ...
                if(ids.length==0){
                	...
                	layer.confirm('确认要删除吗？'/* +ids.toString() */,function(index){
                        ...
                        $.ajax({
                			   type: "post",
                			   url: "${root }/ht/deleteBuildinfoByIds.action?ids="+ids,
