...
<html>
    ...
    <body>
            ...
            <table class="layui-table">
                ...
                <c:forEach items="${baominginfo}" var="baominginfo">
						...
						<c:forEach items="${fabuinfo}" var="fabuinfo">
			                ...
			                <%-- <td class="td-manage">
	                        	<button class="layui-btn" onclick="xiangqing(${baominginfo.id})" type="submit">详情</button>
	                        </td> --%>
	                        <td class="td-manage">
                            <button class="layui-btn" onclick="role_add('详情窗口','${root}ptyh/selectgerencansaixiangqing.action?fabuinfoid=${baominginfo.fabuinfoid}','900','500')">
				           	 	详情
				            </button>
                        </td> 
	                        </tr>
        ...
        <script>
           ...
           /* function xiangqing(fabuinfoid){
        		var params="fabuinfoid="+fabuinfoid;
        		$.ajax({
        			   type: "POST",
        			   url: "${root}ptyh/selectbisaiinfo.action",
        			   data: params,
