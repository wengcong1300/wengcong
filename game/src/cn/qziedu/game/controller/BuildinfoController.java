...
public class BuildinfoController {
	...
	//显示查询所有发布的竞赛信息
	@RequestMapping("/selallBuildinfo.action")
	public String selallBuildinfo(Model model) {
		List<Buildinfo> buildinfo=buildinfoService.selallBuildinfo();
		model.addAttribute("buildinfo", buildinfo);
		return "index/selectbuildinfo";
	}
