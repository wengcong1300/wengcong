...
@Controller
@RequestMapping("/ht")
public class FabuinfoController {
	...
	public String seljinxingzhong(HttpSession session,Model model) {
		...
		model.addAttribute("users", users);
		model.addAttribute("fabuinfo", list);
		return "index/selectjinxingzhong";
	}
